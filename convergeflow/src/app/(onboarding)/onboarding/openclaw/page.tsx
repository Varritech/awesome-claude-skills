    ...
    <div className="min-h-screen bg-cf-page flex flex-col items-center justify-center px-5 py-10">
      <div className="w-full max-w-[640px] animate-[fadeUp_0.5s_ease-out]">
        ...
        <div className="flex items-center justify-center gap-3 mb-12">
          ...
          <span className="text-[20px] font-bold tracking-[-0.03em] italic">
            ConvergeFlow
          </span>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#1E1B10] to-cf-card rounded-[24px] p-9 mb-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-base font-bold mb-0.5">OpenClaw — Done With You</h2>
          ...
          <div className="flex gap-2.5">
            <input
              ...
              className="flex-1 bg-[#222228] border-none rounded-[14px] py-3.5 px-[18px] text-sm text-white outline-none placeholder:text-white/35 font-['DM_Sans']"
            />
            <button
              type="button"
        ...
        <div className="text-center mb-6">
          <button
            type="button"
            className="inline-flex items-center justify-center gap-2.5 bg-[#22C55E] text-white text-sm font-bold py-3.5 px-8 rounded-[14px] border-none cursor-pointer transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(34,197,94,0.3)]"
          >
